...
public class BaseTest {
    protected static final String BASE_URL = "http://3.68.165.45/";
    ...
    protected Integer createPlayerTest(String editor, Integer age, String gender, String login, String screenName, String password, String role, Integer status){
